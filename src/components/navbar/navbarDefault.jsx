...
const NavbarDefault = () => {
  ...
  return (
    <div className='hidden md:flex justify-between items-center fixed w-full backdrop-blur-sm p-4 px-10 lg:px-16 top-0 z-20 border-solid border-b border-gray-300'>
