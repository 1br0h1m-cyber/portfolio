...
const Works = () => {
  return (
    <div id='works' className='flex flex-col justify-center items-center'>
      ...
      <div className='flex flex-col justify-center items-center shadow-lg rounded-lg w-[90%] bg-gray-50 pb-8 m-5 md:mt-7 lg:mt-10'>
        <img src={Weather} alt="" className='p-4 sm:p-6 md:p-8 lg:p-12 pt-8 pb-4 md:pb-8'/>
        <div className='w-[90%]'>
          <h1 className='px-2 py-1 font-bold text-[20px]'>Weather website</h1>
          <p  className='px-2 py-1 text-[15px] md:text-[18px]'>A weather website provides real-time updates on temperature, humidity, and precipitation for different locations. Users can check forecasts for the next few days, helping them plan their activities accordingly.</p>
          <h1 className='px-2 py-1 font-bold text-[20px]'>Stack:</h1>
          <h3 className='px-2 py-1'>Html,Css,Js; © OpenWeather</h3>
          <a href="https://1br0h1m-cyber.github.io/weather/" className='flex justify-center items-center h-10 w-20 font-medium rounded-lg shadow-lg text-white bg-blue-600 hover:bg-blue-700 transition-all mx-2 mt-5'>Visit</a>
        </div>
      </div>
